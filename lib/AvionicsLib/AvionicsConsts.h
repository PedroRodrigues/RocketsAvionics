...
#define DEBUG_BUZZER                1         // set 0 for flight; set 1 for silence;
#define DEBUG_BUZZER_TIME_MS        500       // activation pulse time in milliseconds

#define UPDATE_RATE_STATE           20        // hertz;
#define UPDATE_RATE_GPS             1         // hertz;
#define UPDATE_RATE_TELEMETRY       1         // hertz;
#define UPDATE_RATE_ALTITUDES       1         // hertz;

#define UPDATE_DELAY_STATE          1000/UPDATE_RATE_STATE
#define UPDATE_DELAY_ALTITUDE       1000/UPDATE_RATE_ALTITUDES           
#define UPDATE_DELAY_GPS            1000/UPDATE_RATE_GPS          
#define UPDATE_DELAY_TELEMETRY      1000/UPDATE_RATE_TELEMETRY    

#define AGL_CALIBRATION_SAMPLES     150       // vector size;
#define AGL_CALIBRATION_TIME        5         // seconds;

#define AGL_VARIANCE_THRESHOLD      10        // meters;

#define IMU_ADDRESS                 0x68      // hexadecimal address
#define BMP280_ADDRESS              0x76      // hexadecimal address

#define RFM95_CS                    15        //LoRa Chip Select
#define RFM95_RST                   30        //LoRa Reset
#define RFM95_INT                   29        //LoRa Interupt (G0)
#define RF95_FREQ                   915.0     //LoRa Frequency
#define PACKET_SIZE                 8         //LoRa Packet Size
...
#define THRESHOLD_LIFTOFF           50  //50     // altitude AGL;
#define THRESHOLD_PARACHUTE         0.50      // percentage;
#define THRESHOLD_MAIN              500    //500   // altitude AGL;
#define THRESHOLD_TOUCHDOWN         50  //50      // altitude AGL;
